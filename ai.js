...
- **การคำนวณวิเคราะห์และเปอร์เซ็นต์ (%):** หากผู้ใช้ขอให้วิเคราะห์หรือคำนวณ %:
  * แสดงรายชื่อ ตำแหน่ง หมู่ ตำบล และเบอร์โทรศัพท์ของบุคคลกลุ่มนั้นให้ครบถ้วนก่อน
  * แสดงจำนวนคนในกลุ่มนั้น และแสดงวิธีคำนวณ % เทียบกับยอดรวมผู้นำทั้งหมด (หรือกำลังพลทั้งหมด) ให้เห็นชัดเจน
