  ...
  try {
    ...
    if (userText.length >= 2) {
      if (userText === '/ค้นหาชื่อผู้ต้องหา') {
        return replyText(replyToken, '🔍 สามารถค้นหาด้วย เลขเบอร์โทรศัพท์หรือชื่อ-นามสกุล เช่น นายสมชาย ใจรักดี \nหรือคดีที่ต้องการค้นหา เช่น ลักทรัพย์ วิ่งราว ปล้น กัญชา ยาเสพติด \n\nระบบจะแสดงข้อมูลชื่อ-นามสกุลและรายละเอียดที่ตรงกับข้อมูลที่ค้นหา');
      }
